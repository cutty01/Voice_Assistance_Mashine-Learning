...
'запусти бота': 'starting_bot бот был успешно запущен',
'запусти телегу': 'telegram готово!',
'включи вайбовую песню': 'vibe_music запущено!',
'закрой браузер': 'closed_browser',
'включи ютуб': 'youtube ок',
'найди негра': 'negr ok',
'включи порно': 'porn ok',
'включи мой плейлист': 'playlist1 качовый хайпер поп успешно запущен',
'выключи игру': 'stop_game',
'сверни окно': 'svernyt'
}